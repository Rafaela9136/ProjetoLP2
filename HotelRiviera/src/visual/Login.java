	...
	public Login() {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Main.getHotel().pesquisaConta(textField.getText(), String.valueOf(passwordField.getPassword()))) { // String.valueOf(passwordField.getPassword()) <-- caso precise procurar pela senha tamb�m.
					try {
