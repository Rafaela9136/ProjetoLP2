...
public class AcoesRecursos extends JPanel {
	
	/**
	 */
	private static final long serialVersionUID = -2440430890111404164L;
	 ...
	 */
	public AcoesRecursos() throws ParseException {
...
//				layout.show(vazio, "vazio");
		...
		add(pesquisarContrato, "pesquisarContrato");
		...
		add(atualizarContrato, "atualizarContrato");
		...
		add(detalhesContrato, "detalhesContrato");
		...
		btnAtualizarContrato.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				layout.show(atualizarContrato, "atualizarContrato");
			}
		});
