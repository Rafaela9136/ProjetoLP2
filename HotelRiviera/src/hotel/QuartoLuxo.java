...
/**
 * Representa um quarto do tipo luxo. Os quartos luxos podem ser simples(1
 * hospede), duplo (2 hospedes) ou triplo (tres hospedes).
 * 
 * @author Grupo
 * @version 1.0
 * 
...
public class QuartoLuxo extends Quarto {
	...
	/**
	 * Compara dois objetos QuartoLuxo e informa se sao iguais ou nao. Dois
	 * quartos Luxos s�o iguais se forem iguais no preco, na solicitacao de cama
	 * extra e no tipo (simples, duplo ou triplo).
	 * 
	...
	public String toString() {
		return "\nQuarto Luxo " + tipoDeQuarto.getNome() + ": " + getPreco()
				+ super.toString();
	}
