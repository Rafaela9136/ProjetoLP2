...
public enum TiposDeQuarto implements Serializable {
	SIMPLES(1, 5, true, "Simples"), DUPLO(2, 15, true, "Duplo"), TRIPLO(3, 20,
			false, "Triplo");
	...
	private TiposDeQuarto(int MAX_HOSPEDES, int TOTAL_DISPONIVEL,
			boolean PERMITE_CAMA_EXTRA, String nome) {
